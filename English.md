...
* path type explanation: Book source, subscription source, replacement rules, local txt novel directory rules, online reading engine, theme, reading layout, [add to bookshelf](/native/app/src/main/java/io/legado/app/ui/association/AddToBookshelfDialog.kt)
...
* [Update Log](/native/app/src/main/assets/updateLog.md)
* [Help Documentation](/native/app/src/main/assets/web/help/md/appHelp.md)
