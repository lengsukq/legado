# 阅读[API](/native/app/src/main/java/io/legado/app/api/controller)

## 对于[Web](/native/app/src/main/java/io/legado/app/web/)的配置
...
请求BODY内容为`JSON`字符串，  
格式参考[这个文件](/native/app/src/main/java/io/legado/app/data/entities/BookSource.kt)
...
请求BODY内容为`JSON`字符串，  
格式参考[这个文件](/native/app/src/main/java/io/legado/app/data/entities/BookSource.kt)，**为数组格式**。
...
请求BODY内容为`JSON`字符串，  
替换规则参考[这个文件](/native/app/src/main/java/io/legado/app/data/entities/ReplaceRule.kt)。
...
请求BODY内容为`JSON`字符串，  
格式参考[这个文件](/native/app/src/main/java/io/legado/app/data/entities/Book.kt)。
...
请求BODY内容为`JSON`字符串，  
格式参考[这个文件](/native/app/src/main/java/io/legado/app/data/entities/BookProgress.kt)。
...
### [Content Provider](/native/app/src/main/java/io/legado/app/api/ReaderProvider.kt)
